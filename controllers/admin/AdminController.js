...
console.log(user);
      ...
      //console.log(user + "__" + user.password);
  ...
  if (errors) {
    ...
    if (CheckAuthentication.length > 0) {
      ...
      if (projectDetail.length > 0) {
        ...
        const customerDetail = await Users.getUserByid(
          projectDetail[0].user_id
        );
